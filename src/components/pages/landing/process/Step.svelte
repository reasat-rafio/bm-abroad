...
<div bind:this={stepEl} class="grid grid-cols-12 !overflow-visible">
  <div
    class="col-span-1 flex translate-y-[40px] flex-col items-center justify-center"
  >
    <div class="my-2">
      {#if isIntersecting}
        <svg
  ...
  <div
    class="col-span-11 space-y-[16px] pb-[150px] {isIntersecting
      ? 'scale-100'
