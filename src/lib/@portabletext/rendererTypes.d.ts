...
export declare type PortableTextComponents =
  Partial<PortableTextSvelteComponents>;
declare type BlockComponent =
  | SvelteComponentTyped<{
      portableText: BlockComponentProps;
    }>
  | typeof SvelteComponent;
declare type CustomBlockComponent =
  | SvelteComponentTyped<{
      portableText: CustomBlockComponentProps;
    }>
  | typeof SvelteComponent;
declare type MarkComponent =
  | SvelteComponentTyped<{
...
declare type ListComponent =
  ...
  | typeof SvelteComponent;
declare type ListItemComponent =
  | SvelteComponentTyped<{
