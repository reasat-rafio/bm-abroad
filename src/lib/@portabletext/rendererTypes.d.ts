...
export declare type MissingComponentHandler = (message: string, context: {
    type: string;
    nodeType: NodeType;
}) => void;
...
export declare type CustomStyles = Record<PortableTextBlockStyle, BlockComponent | undefined> | BlockComponent;
export declare type CustomMarks = Record<PortableTextMarkType, MarkComponent>;
export declare type CustomTypes = Record<string, CustomBlockComponent>;
...
export declare type PortableTextComponents = Partial<PortableTextSvelteComponents>;
declare type BlockComponent = SvelteComponentTyped<{
    portableText: BlockComponentProps;
}> | typeof SvelteComponent;
declare type CustomBlockComponent = SvelteComponentTyped<{
    portableText: CustomBlockComponentProps;
}> | typeof SvelteComponent;
declare type MarkComponent = SvelteComponentTyped<{
    portableText: MarkComponentProps;
}> | typeof SvelteComponent;
declare type ListComponent = SvelteComponentTyped<{
    portableText: ListComponentProps;
}> | typeof SvelteComponent;
declare type ListItemComponent = SvelteComponentTyped<{
